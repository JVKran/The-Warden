...
void Game::loadCharacters(){
	characters.push_back(Character(sf::Vector2f(200,350), std::make_shared<PlayerInput>(), std::make_shared<PlayerPhysics>(), std::make_shared<PlayerGraphics>("crate", assets), lootDrop, true));
	characters.push_back(Character(sf::Vector2f(200,350), std::make_shared<EnemyInput>(), std::make_shared<PlayerPhysics>(), std::make_shared<EnemyGraphics>("bush1", assets), lootDrop));
}