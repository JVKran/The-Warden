...
int main(){
	...
	std::vector<KeyBinding> bindings { 
		...
		KeyBinding ( "Set Layer 2",				sf::Keyboard::F2,		Text( "Set Layer 2 : F2",					sf::Vector2f{960.0, 400.0},  1, sf::Color::Black, 1 )),
		KeyBinding ( "Set Layer 3",				sf::Keyboard::F3,		Text( "Set Layer 3 : F3",					sf::Vector2f{960.0, 440.0},  1, sf::Color::Black, 1 )),
		KeyBinding ( "Set Layer 4",				sf::Keyboard::F4,		Text( "Set Layer 4 : F4",					sf::Vector2f{960.0, 480.0},  1, sf::Color::Black, 1 )),
		KeyBinding ( "Set interactable",		sf::Keyboard::F5,		Text( "Set interactable : F5",				sf::Vector2f{960.0, 520.0},  1, sf::Color::Black, 1 )),
