...
int main(){
	...
	std::vector<KeyBinding> bindings { 
		KeyBinding ( "Left", 		sf::Keyboard::A,  		Text( "Left : A", 		sf::Vector2f{500.0, 50.0}, 	1, sf::Color::Black, 1 )		),
		KeyBinding ( "Right",		sf::Keyboard::D, 		Text( "Right : D", 		sf::Vector2f{500.0, 125.0}, 1, sf::Color::Black, 1 )		),
		KeyBinding ( "Jump", 		sf::Keyboard::Space, 	Text( "Jump : Space", 	sf::Vector2f{500.0, 200.0}, 1, sf::Color::Black, 1 ) 		),
		KeyBinding ( "E",			sf::Keyboard::E,		Text( "Use : E",		sf::Vector2f{500.0, 275.0}, 1, sf::Color::Black, 1)			)
	};
