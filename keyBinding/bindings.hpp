...
std::array< KeyBinding, 5 > Bindings = { 
	KeyBinding ( "Backward", 	sf::Keyboard::A,  		Text( "Backward : A", 	sf::Vector2f{320.0, 50.0}, 	1.0, sf::Color::Red )	),
	KeyBinding ( "Forward",		sf::Keyboard::D, 		Text( "Forward : D", 	sf::Vector2f{320.0, 80.0}, 	1.0, sf::Color::Red )	),
